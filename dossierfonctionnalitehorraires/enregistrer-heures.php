...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styleEnregistrerHeures.css" />
...
<body>
    ...
    <h1>Les heures ont été enregistrées</h1>
...
//et les enregistrer dans le csv 
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $file = fopen('heures.csv', 'a+');
        // ecriture les en-têtes dans le fichier CSV
        //fputcsv($file, ['Semaine', 'Dimanche', 'Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi']);
