...
lireCSVcongés(userId+'/congés.csv', function(joursConges) {
    bool1 =true
    verifAffichage();
});
...
function lireCSV_horaires(url, callback) {
    ...
    lireCSV_horaires(userId+'/horaires.csv', function(heure) {
        bool2 = true;
    verifAffichage();
});
...
lireCSV_absence(userId+'/Absences.csv', function(absence) {
    bool3 = true;
verifAffichage();
});
